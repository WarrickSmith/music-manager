...
export default function RegisterPage() {
  ...
  return (
    <div className="space-y-8 py-10 px-4 bg-gradient-to-b from-purple-50/50 to-blue-50/50 min-h-screen">
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-purple-100 p-8 max-w-md mx-auto transition-all hover:shadow-xl">
